...
- A brain is optional, though it is highly recommended.

To run the application, open a terminal window to access the command line.
Navigate to the directory where the sqs-0.0.1.jar file is located.  
At the prompt type the following command:
java -jar sqs-0.0.1.jar

The files in the "data" directory contain all the data that will be accessed by the application.  Please don't remove or rename the files in that directory, or the program will cease to function and you will stop enjoying all its benefits.
...
If you have any real questions, find any bugs or have any constructive criticism, feel free to e-mail the author at: alejandro.leon@msaamericas.com
