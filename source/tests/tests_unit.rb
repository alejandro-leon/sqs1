...
# The second try, the integer 24 was replaced by 24.0 (float). Test passed
  def test_lines_price
    x = [[1, 2, 3, 4, 5, 6], [1, 2, 3, 4, 5, 6]] #sample array used as productTable
    assert_equal(24.0, Stub.new.calculate_lines_price(x))
...
# Test for the calculate_total_weight method.
...
# all the above tests for the result of this one.
  def test_calculate_subtotal_price
...
# Test for the calculate_tax_price method.
 def test_calculate_tax_price
   assert_equal(3.0576,Stub.new.calculate_tax_price(23.52))
 end
=begin 
 Results:
 Loaded suite tests_unit
Started
.
Finished in 0.150000 seconds.

1 tests, 1 assertions, 0 failures, 0 errors, 0 skips

Test run options: --seed 58535
=end 

# Test for the calculate_total_price method.
...
Started
.
Finished in 0.065000 seconds.

1 tests, 1 assertions, 0 failures, 0 errors, 0 skips

Test run options: --seed 781
=end
end